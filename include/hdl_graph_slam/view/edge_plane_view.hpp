...
public:
	EdgePlaneView(g2o::HyperGraph::Edge *edge, LineBuffer &line_buffer) :
	...
	virtual Eigen::Vector3f representative_point() const override {
		VertexPlaneCache *cache1 =
				dynamic_cast<VertexPlaneCache*>(v1->userData());
		VertexPlaneCache *cache2 =
				dynamic_cast<VertexPlaneCache*>(v2->userData());
		if (cache1 == nullptr || cache2 == nullptr) {
			std::cerr << "warning: vertex plane cache has not been created!!"
					<< std::endl;
	...
	static bool is_plane_edge(g2o::HyperGraph::Edge *edge) {
		return dynamic_cast<g2o::EdgePlane*>(edge)
				|| dynamic_cast<g2o::EdgePlaneIdentity*>(edge)
				|| dynamic_cast<g2o::EdgePlaneParallel*>(edge)
				|| dynamic_cast<g2o::EdgePlanePerpendicular*>(edge);
	}
private:
	g2o::VertexPlane *v1;
	g2o::VertexPlane *v2;
