...
public:
   ...
   * @param pnh
   */
  LoopDetector(NodeHandle &pnh) {
    distance_thresh = pnh.distance_thresh;
    accum_distance_thresh = pnh.accum_distance_thresh;
    distance_from_last_edge_thresh = pnh.min_edge_interval;

    fitness_score_max_range = pnh.fitness_score_max_range;
    fitness_score_thresh = pnh.fitness_score_thresh;
